...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .left-column {
            display: grid;
            grid-template-rows: minmax(0, 1.8fr) auto auto;
            gap: 10px;
            min-height: 0;
        }
        .video-card {
        ...
        .counter-card {
            ...
            align-items: center;
            justify-content: center;
            box-shadow: 0 3px 10px rgba(30, 63, 134, 0.16);
        ...
        .waiting-row {
            ...
            align-items: center;
            justify-content: center;
            background: linear-gradient(160deg, #eaf6ff, #d6eefa);
            border: 2px solid #7bbfe0;
            border-radius: 15px;
            padding: 16px 9px;
            min-height: 0;
            box-shadow: 0 3px 8px rgba(10, 78, 134, 0.1);
            transition: transform 0.15s ease, box-shadow 0.15s ease;
        }
        .waiting-row:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 14px rgba(10, 78, 134, 0.18);
        }
        .waiting-num {
            font-size: 0.85rem;
            font-weight: 800;
                ...
                <div class="panel waiting-card">
                    ...
                    <div id="waitingList" class="waiting-list">
                        <div class="waiting-row">
                            <div class="waiting-num">#1</div>
                            <div class="waiting-queue-num">--</div>
                        </div>
                        <div class="waiting-row">
                            <div class="waiting-num">#2</div>
                            <div class="waiting-queue-num">--</div>
                        </div>
                        <div class="waiting-row">
                            <div class="waiting-num">#3</div>
                            <div class="waiting-queue-num">--</div>
                        </div>
                        <div class="waiting-row">
                            <div class="waiting-num">#4</div>
                            <div class="waiting-queue-num">--</div>
                        </div>
                    </div>
                </div>
